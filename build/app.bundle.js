...
_ui.ui.post_collection.addEventListener("click", enableEditPostHandler);

_ui.ui.post_btn_group.addEventListener("click", cancelEditPostHandler);
...
function submitPostHandler(e) {
  if (_ui.ui.validateInputFields()) {
    var post_data = {
      title: _ui.ui.post_title.value,
...
function enableEditPostHandler(e) {
  ...
  if (e.target.parentElement.classList.contains("edit-post")) {
    ...
    var post_title = e.target.parentElement.previousElementSibling.previousElementSibling.textContent;
    var post_body = e.target.parentElement.previousElementSibling.textContent;
    var post_edit_data = {
      id: id,
      post_title: post_title,
      post_body: post_body
    };
    _ui.ui.fillPostForm(post_edit_data);
  }
}
...
var UI = function () {
  ...
  _createClass(UI, [{
    key: "validateInputFields",
    value: function validateInputFields() {
    ...
    key: "fillPostForm",
    value: function fillPostForm(post_edit_data) {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                return _context.abrupt("return", this.checkResponse(response));
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 2:
                ...
                return _context2.abrupt("return", this.checkResponse(response));
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              ...
              case 2:
                ...
                return _context3.abrupt("return", this.checkResponse(response));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              ...
              case 2:
                ...
                return _context4.abrupt("return", this.checkResponse(response));
